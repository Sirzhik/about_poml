...
<html>
	...
	<body>
		...
		<h2 style="color: blue">Какие будут обновления дальше?</h1>
		<hr>

		В версии ABot4 будет повышена производительность.<strong></strong> 

		<h2 style="color: blue">На какие ОС можно установить?</h1>
		<hr>	

		Пока бот работает только в .exe, но автор планирует выпустить бота и под Debian(Linux). 

		<h2 style="color: green">Какие ещё есть проекты?</h1>
		<hr>		
		...
		<h2 style="color: red">Какие ещё есть приложения?</h1>
		<hr>	
